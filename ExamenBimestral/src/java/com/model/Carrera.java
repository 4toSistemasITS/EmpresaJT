...
@NamedQueries({
    ...
    , @NamedQuery(name = "Carrera.findByEliminado", query = "SELECT c FROM Carrera c WHERE c.eliminado = :eliminado")
    , @NamedQuery(name = "Carrera.findByFechaRegistro", query = "SELECT c FROM Carrera c WHERE c.fechaRegistro = :fechaRegistro")})
public class Carrera implements Serializable {
    ...
    public String toString() {
        return "com.model.Carrera[ idCarrera=" + idCarrera + " ]";
    }
